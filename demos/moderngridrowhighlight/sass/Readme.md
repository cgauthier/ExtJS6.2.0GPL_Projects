...
folder are mapped to the application's root namespace, 'ModernGridRowHighlight'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ModernGridRowHighlight"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ModernGridRowHighlight' in the same way
as `"ModernGridRowHighlight/sass/src"`.
